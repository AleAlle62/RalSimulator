...
{
    /**
     * The twenty two single figures the engine needs: contribution rates and ceilings, the
     * relief thresholds and amounts, the 75 euro offset.
     *
     ...
     * allowed keys live in a PHP enum and a test asserts every one of them is present.
     */
