<!--
  Vue Bits — Silk (https://vue-bits.dev), MIT.
  Vendored, not installed: vue-bits ships source through the jsrepo CLI rather than as a runtime
  package. Kept verbatim so it can be re-synced against upstream; project palette, reduced-motion
  handling and any accessibility work live in the wrapper next to it, not in here.
-->
<template>
