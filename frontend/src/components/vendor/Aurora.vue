<!--
  Vue Bits — Aurora (https://vue-bits.dev), MIT.
  Vendored rather than installed: vue-bits ships source via the jsrepo CLI, not as a runtime
  package. Kept verbatim so it can be re-synced against upstream; the reduced-motion handling
  and the project palette live in AuroraBackdrop.vue, which wraps this.
-->
<template>
